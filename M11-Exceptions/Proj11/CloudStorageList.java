...
/**
      ...
      while (readFile.hasNextLine())
      {
         ...
         try
         {
            switch (category)
            {
               ...
               default:
                  throw new InvalidCategoryException(cloudType);
              
            }
         
         }
         catch (NumberFormatException errorTypeOne)
         {
            addInvalidRecord(line + "\n" + errorTypeOne);
         }
         catch (NoSuchElementException errorTypeTwo)
         {
            addInvalidRecord(line + "\n" + errorTypeTwo 
                            + ": For missing input data");
         }
         catch (InvalidCategoryException errorTypeThree)
         {
            addInvalidRecord(line + "\n" + errorTypeThree);
         }
 ...
 /****************************************************************************
  * generates a report of the InvalidRecordsArray.
  * @return report in string
  *****************************************************************************/
   public String generateInvalidRecordsReport()
   {
      String report = "----------------------"
                    ...
                    + "\n----------------------";             
      for (String invalidRecord : invalidRecordsArray)
      {
         report += "\n" + invalidRecord + "\n";
      } 
