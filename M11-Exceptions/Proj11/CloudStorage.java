...
public abstract class CloudStorage implements Comparable<CloudStorage>
{
  ...
  * @param storageIn the one you want to compare with
  * @return int of which is greater
  **********************************************************************/   
   public int compareTo(CloudStorage storageIn)
   {
      return name.toLowerCase().compareTo(storageIn.getName().toLowerCase());
   }
  
 /************************************************************************
  * sees if two cloud arrays are equal.
  * @param obj array
