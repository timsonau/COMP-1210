...
{  
  ...
  /**
   ...
   /**
     *public static method that returns number of Ellipsoid created.
     *@return count
     */
  ...
  /**
    *public static method that sets count to 0.
    */ 
   ...
   /**
     *public method that checks if two Ellipsoids are equal. 
     *@param obj in
     *@return boolean
     */
